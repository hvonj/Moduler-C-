...

{
    ...
    public class NumberToNumberTests
    {
        ...
        public void SumNumbersTo()
        {
            ...
            Assert.AreEqual(1 + 2, x.SumNumbersTo(2)); //om användaren anger tal 3 så ska output bli 1+2
            Assert.AreEqual(1 + 2 + 3, x.SumNumbersTo(3)); //6
            Assert.AreEqual(1 + 2 + 3 + 4, x.SumNumbersTo(4)); //10
        ...
        { //Summera de nummer som går att dela på 3 eller 5
            var x = new NumberToNumber();
